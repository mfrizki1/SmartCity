...
import id.co.iconpln.smartcity.util.ext.OnTextChangedListener
import id.co.iconpln.smartcity.util.ext.onFocusChanged
import kotlinx.android.synthetic.main.view_input_edit_text.view.*


class InputEditText(context: Context, attrs: AttributeSet) : FrameLayout(context, attrs), WidgetEditTextAbs{
